...
5. No ejecutes cambios de estructura (DDL: create/alter/drop): déjalos como script SQL listo en `db/` e indica al dev que los ejecute en su MySQL local (Docker). La manipulación de datos (DML: insert/update/delete) sí puedes ejecutarla.
